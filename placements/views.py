...
#View function for student registration portal.
...
def user_login(request):
	if request.method == 'POST':
		...
		if user:
			if user.is_active():
				login(request,user)
				return HttpResponse(" Congrats! You have successfully logged in.")
			else:
				return HttpResponse("Your TPO account is disbaled.")
		else:
